	...
	public partial class ConfigManager : Node
	{
		...
		private int _hpPotionHeal = 10;
		private int _apPotionHeal = 5;

		public int GetHpPotionHeal() => _hpPotionHeal;
		public int GetApPotionHeal() => _apPotionHeal;
		...
		if (_configData.ContainsKey("potion_settings"))
		{
			var potion = (Dictionary)_configData["potion_settings"];

			if (potion.ContainsKey("hp_heal_amount"))
				_hpPotionHeal = (int)potion["hp_heal_amount"];

			if (potion.ContainsKey("ap_heal_amount"))
				_apPotionHeal = (int)potion["ap_heal_amount"];
		}
	}
